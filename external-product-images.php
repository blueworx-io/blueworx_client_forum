...
/*
 * The repo is public, so no token is needed. If it is ever made private again,
 * the site needs a read-only token to see releases at all. It lives in
 * wp-config.php, never in the plugin and never in the repo:
 *
