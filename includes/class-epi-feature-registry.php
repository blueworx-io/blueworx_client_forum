...
final class EPI_Feature_Registry {
	...
	public static function groups() {
		return array(
			...
			'account'         => __( 'Account', 'blueworx_client_forum' ),
			'admin-email'     => __( 'Admin & email', 'blueworx_client_forum' ),
			'admin-product'   => __( 'Admin product tools', 'blueworx_client_forum' ),
			'tools'           => __( 'Tools', 'blueworx_client_forum' ),
			'debug'           => __( 'Debug', 'blueworx_client_forum' ),
		);
	}
	...
	public static function definitions() {
		...
		return array(
			...
			'fitting-instructions-button' => array(
				'title'          => __( 'Fitting instructions button', 'blueworx_client_forum' ),
				'description'    => __( '[fitting_instructions_button] -builds the fitting-sheet PDF link from the SKU (only if the file exists).', 'blueworx_client_forum' ),
				'group'          => 'product-display',
				'dangerous'      => false,
				'danger_message' => '',
				'dependencies'   => array( 'woocommerce' ),
			...
			'hide-cart-for-guests'    => array(
				...
				'group'          => 'shop',
				'dangerous'      => true,
				'danger_message' => __( 'This currently blocks logged-out visitors from purchasing. Turning it off lets guests add products to the cart. Are you sure?', 'blueworx_client_forum' ),
				'dependencies'   => array( 'woocommerce' ),
